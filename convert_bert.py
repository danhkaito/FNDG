...
with open(f"../clean data/{args.dataset}/data_embedding/{args.name_model}/train_sentence_{args.token_length}.npy", "wb") as f:
...
with open(f"../clean data/{args.dataset}/data_embedding/{args.name_model}/test_label_{args.token_length}.npy", "wb") as f:
